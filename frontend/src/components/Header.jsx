        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg hidden sm:block">SchoolHub</span>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <a href="#" className="hover:text-[#2563EB] transition-colors">Clubs</a>
          ...
          <div className="flex items-center gap-2">
            ...
            {showProfile ? (
                  ...
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="w-8 h-8 p-0">
                      <Avatar className="w-8 h-8">
                        <AvatarFallback className="bg-[#2563EB] text-white">AN</AvatarFallback>
                      </Avatar>
                    </Button>
                  </DropdownMenuTrigger>
              ...
              <div className="flex items-center gap-2">
                ...
                <Button className="bg-[#2563EB] hover:bg-blue-700">Register</Button>
              </div>
            )}
          </div>
        </div>
